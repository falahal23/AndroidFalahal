...
class FourthActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityFourth3Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        Log.e("onCreate", "Fourth activity terlihat d layar")
        enableEdgeToEdge()
    ...
    override fun onStart() {
        super.onStart()
        Log.e("onStart", "Fourth activity terlihat d layar")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.e("onDestroy", "Fourth activity terlihat d layar")
    }
